    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\Parikshit Sharma\\Desktop\\Attendance-Management-system-using-face-recognition\\attendance(Manually)\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:/Users/C:\\Users\\Parikshit Sharma\\Desktop\\Attendance-Management-system-using-face-recognition\\attendance/OneDrive/Documents/E/FBAS/Attendance(Manually)"'
                )
